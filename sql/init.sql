...
CREATE TABLE `ai_provider` (
    `name` VARCHAR(80) NOT NULL COMMENT 'Provider unique name',
    ...
    INDEX `idx_vision_enabled`(`vision_enabled`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI provider pool' ROW_FORMAT = Dynamic;
